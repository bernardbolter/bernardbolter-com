# Moondream Prompt Spec — FieldNotes Pipeline
## Per-shot-type prompting for keyframe tagging
...
*Not to be confused with `vision-analysis-prompt-spec.md` — that file is the frozen **artwork** A-1.0 prose prompt for `visionAnalyses[]` on Artwork records.*
