...
export const enum_artworks_units = pgEnum('enum_artworks_units', ['metric', 'imperial'])
...
export const artworks = pgTable(
  'artworks',
  {
    ...
    artworkImage: integer('artwork_image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    ...
    units: enum_artworks_units('units'),
    ...
    storyEn: jsonb('story_en'),
    storyDe: jsonb('story_de'),
    exhibitionHistory: jsonb('exhibition_history'),
    provenance: jsonb('provenance'),
    printEditions: jsonb('print_editions'),
    wp_id: numeric('wp_id', { mode: 'number' }),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
    createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 })
  ...
  (columns) => [
    uniqueIndex('artworks_slug_idx').on(columns.slug),
    index('artworks_artwork_image_idx').on(columns.artworkImage),
    index('artworks_updated_at_idx').on(columns.updatedAt),
    index('artworks_created_at_idx').on(columns.createdAt),
  ],
)
...
export const payload_locked_documents_rels = pgTable(
  'payload_locked_documents_rels',
  {
    ...
    artworksID: integer('artworks_id'),
  },
  (columns) => [
    ...
    index('payload_locked_documents_rels_artworks_id_idx').on(columns.artworksID),
    foreignKey({
...
export const relations_artworks = relations(artworks, ({ one }) => ({
  artworkImage: one(media, {
    fields: [artworks.artworkImage],
    references: [media.id],
    relationName: 'artworkImage',
  }),
}))
...
export const relations_payload_locked_documents_rels = relations(
  ...
  ({ one }) => ({
    ...
    artworksID: one(artworks, {
      fields: [payload_locked_documents_rels.artworksID],
...
type DatabaseSchema = {
  enum_artworks_units: typeof enum_artworks_units
  ...
  relations_artworks: typeof relations_artworks
