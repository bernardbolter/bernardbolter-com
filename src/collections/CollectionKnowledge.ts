...
export const CollectionKnowledge: CollectionConfig = {
  slug: 'collection-knowledge',
  labels: { singular: 'Collection knowledge', plural: 'Collection knowledge' },
  admin: {
    useAsTitle: 'sectionLabel',
    defaultColumns: ['slug', 'sectionLabel', 'status', 'order', 'updatedAt'],
    description: 'Briefs the Art/Official agent for collector-cataloguing sessions.',
  },
  access: {
    read: ({ req: { user } }) => {
